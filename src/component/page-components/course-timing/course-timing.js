function CourseTimingComponent() {
  return (
    <div className="text-[#fff]">
      <div className="text-2xl font-medium flex-wrap text-[#ed970b] pt-[8px] pb-[12px] flex justify-center items-center mt-[16px]">Session details <span className="text-[14px] mt-[4px] pl-[4px] pr-[2px] text-[#fff]">(Only on weekends)</span> :</div>
      ...
      <div className="text-2xl font-medium text-[#fff] pt-[8px] pb-[12px] text-center max-[550px]:text-[16px] max-[550px]:leading-[140%]">
        Classes will be held over
        <span className="text-[#ed970b]">&nbsp;6 days, 3 hours per day, for a total of 18 hours</span>.
